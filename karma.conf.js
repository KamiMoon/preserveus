...
module.exports = function(config) {
    config.set({
        ...
        files: [
            ...
            "client/bower_components/angularUtils-disqus/dirDisqus.js",
            "client/bower_components/ng-file-upload/ng-file-upload.js",
            "client/bower_components/ng-file-upload-shim/ng-file-upload-shim.js",
            "client/bower_components/ngstorage/ngStorage.js",
            "client/bower_components/swipebox/src/js/jquery.swipebox.js",
            'client/app/app.js',
            'client/app/**/*.js',
            'client/components/**/*.js',
            'client/app/**/*.html',
            'client/components/**/*.html',
            'client/assets/cloudinary/jquery.cloudinary.js',
            'client/assets/cloudinary/angular.cloudinary.js'
        ],
